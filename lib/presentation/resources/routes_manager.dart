...
import 'package:flutter_advanced/presentation/on_boarding/on_boarding_view.dart';
...
switch(settings.name){
  ...
  case Routes.signUpRoute: return MaterialPageRoute(builder: (_)=>SignUpView());
  case Routes.forgotPasswordRoute: return MaterialPageRoute(builder: (_)=>const ForgotPasswordView());
  case Routes.homeRoute: return MaterialPageRoute(builder: (_)=>HomeView());
  case Routes.storeDetailsRoute: return MaterialPageRoute(builder: (_)=>StoreDetails());
  default: return unDefinedRoute();
}
  }
  static Route<dynamic> unDefinedRoute() =>MaterialPageRoute(builder: (_)=>Scaffold(
    appBar: AppBar( title: const Text(AppStringsManager.noRouteFound),
    ),
